      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <p className="text-sm text-muted-foreground leading-relaxed">
              Egypt's premier on-demand manufacturing marketplace. Connecting businesses 
              with certified workshops for precision fabrication.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              {["CNC Machining", "Sheet Metal", "3D Printing", "Wire Cutting", "Die Casting"].map((service) => (
                <li key={service}>
        ...
        <div className="mt-12 pt-8 border-t border-border flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-sm text-muted-foreground">
            © {new Date().getFullYear()} Fabrishare. All rights reserved.
          </p>
